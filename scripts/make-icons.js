 ...
 *
 * IT HAS TO MATCH THREE OTHER PLACES: `PeaksIcon` in src/components/icons.jsx, the inline
 * data-URI favicon in index.html, and the hero's seal. All four are the same ridgeline, and
 * them drifting apart means the installed app and the page it opens carry different logos.
 * icons.jsx records why a leaf or any other notched fan is not available at glyph size.
 *
...
/** --accent (sage) and --accent-text from tokens.css. The sibling uses indigo; see the
    accent note in src/styles/tokens.css for why this site is green. */
const BG = [0x38, 0x58, 0x44]
